...
public class Main {
        public static void main(String[] args) {
                ...
                movie.setData("1", "Harry Potter", "Cover URL", "Thumbnail URL", "This movie is about...",
                                "29 Sept, 2004", "120 minutes", (float) 8.5,
                                new Trailer[] { new Trailer("1", "Harry Potter Preview Trailer", "youtube.com/path",
                                                "mp4", "1"),
                                                new Trailer("2", "Harry Potter Final Trailer", "youtube.com/path",
                                                                "mp4", "1") },
                                new Actor[] { new Actor("1", "Daniel Radcliffe", "30"),
                                                new Actor("2", "Actor 2", "25") },
                                ...
                                new Genre[] { new Genre("1", "Action"), new Genre("2", "Adventure"),
                                                new Genre("3", "Fantasy") });
                ...
                tvSeries.setData("1", "Big Bang Theory", "Cover URL", "Thumbnail URL", "This Tv Series is about...",
                                ...
                                new Trailer[] { new Trailer("1", "Big Bang Theory Preview Trailer", "youtube.com/path",
                                                "mkv", "1"),
                                                new Trailer("2", "Big Bang Theory Final Trailer", "youtube.com/path",
                                                                "mkv", "1") },
                ...
                eventManager.notifyListeners("Upcoming Tv Series", "\nSome upcoming Tv Series are:\n1."
                                + tvSeries.getName() + " (" + tvSeries.getReleaseDate() + ")\n");
                ...
                videoRenderStrategyContext.executeStrategy(movie.getTrailers()[0].getName(),
                                movie.getTrailers()[0].getLink());
        }
}